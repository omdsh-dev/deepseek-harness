...
The shell root is a localized `aside` navigation landmark in both expanded and rail presentations; the workspace package supplies the nested tree semantics rather than making the entire sidebar one oversized tree.
