...
A directory-flow or adoption failure opens a dialog described by its visible alert, initially focuses the non-destructive Cancel action, and restores focus to the connected picker trigger when the dialog closes or **Choose again** starts a fresh flow.
