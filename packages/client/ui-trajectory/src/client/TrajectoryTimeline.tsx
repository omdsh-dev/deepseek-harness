    ...
    <section ref={rootRef} className={css.root} aria-label="Trajectory timeline">
      <div className={css.plot}>
        ...
        <div
          ...
          aria-description="Use arrow keys to browse events, Shift plus an arrow to extend the focused range, Enter to open an event, Control or Command plus A to focus all events, and Escape to clear the range."
                ...
                return (
                  ...
                  >
                    <span
                      ...
                      role="option"
                      aria-label={`${timelineTooltipLabel(span.kind, detail)}; record ${span.index}`}
