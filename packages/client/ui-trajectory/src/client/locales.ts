...
export const zh = {
  ...
  'timeline.keyboardDescription': '使用方向键浏览事件，按住 Shift 再按方向键可扩展聚焦范围，按 Enter 打开事件，按 Control 或 Command 加 A 聚焦全部事件，按 Escape 清除范围。',
  'timeline.recordAria': '{detail}；记录 {record}',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'timeline.keyboardDescription': 'Use arrow keys to browse events, Shift plus an arrow to extend the focused range, Enter to open an event, Control or Command plus A to focus all events, and Escape to clear the range.',
  'timeline.recordAria': '{detail}; record {record}',
