...
export const zh = {
  ...
  'table.events': '轨迹事件',
  'table.keyboardInstructions': '使用上下方向键、Home 和 End 在事件间移动；按 Enter 或空格键打开详情。如果该行有请求标记，右方向键可进入标记，左方向键或 Escape 返回事件。',
  ...
  'details.resizeTitle': '拖动或使用方向键调整；Home/End 跳至最小/最大，Enter 或双击恢复默认值。',
  'details.resizeValue': '{value} 像素',
  'details.close': '关闭详情',
  'details.status': '状态',
  'details.purpose': '用途',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'table.events': 'Trajectory events',
  'table.keyboardInstructions': 'Use Up and Down Arrow, Home, and End to move between events; press Enter or Space to open details. If the row has a request marker, Right Arrow enters it, and Left Arrow or Escape returns to the event.',
  ...
  'details.resizeTitle': 'Drag or use Arrow keys; Home/End sets the minimum/maximum, and Enter or double-click resets.',
  'details.resizeValue': '{value} pixels',
