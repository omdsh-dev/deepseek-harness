...
export const zh = {
  ...
  'message.user': '用户消息',
  'message.steering': '用户插话',
  'message.assistant': '智能体回复',
...
export const en = {
  ...
  'input.composer': 'Message the agent',
  ...
  'chat.responseReady': 'Agent response complete',
  ...
  'message.steering': 'User steering message',
