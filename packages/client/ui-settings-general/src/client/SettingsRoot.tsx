...
/**
 * The Settings panel inside the shared modal layer. The primitive owns the
 * mask, inert background, focus trap, Escape handling, and focus restoration;
 * this component owns the panel layout, navigation, and close button.
 */
