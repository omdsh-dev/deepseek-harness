 ...
 */
export function Menu({ open, anchor, items, selectedId, selectedIds, onSelect, onClose, align = 'start', side = 'bottom', portal = false, closeOnPointerLeave = false, dense = false, compact = false, autoFocus = false, selection = 'check', getAnchorRect, returnFocusRef, ariaLabel, footer, className }: {
  open: boolean
  autoFocus?: boolean
  anchor: ReactNode
    ...
    return (
      ...
      >
        ...
        >
          ...
          {selected && selection === 'check' && <span className={css.check} aria-hidden="true"><IconCheckOutline16 /></span>}
        </button>
