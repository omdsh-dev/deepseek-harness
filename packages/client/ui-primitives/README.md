...
Every visible JsonTree row, including primitive leaves, participates in one roving tree-item Tab stop. Arrow keys, Home, End, Enter, and Space follow the tree pattern; decorative chevrons are hidden from assistive technology.
