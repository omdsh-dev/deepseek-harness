...
export const zh = {
  ...
  'chat.announcement.response.started': '回答已开始。',
  'chat.announcement.response.completed': '回答已完成。',
  'chat.announcement.response.failed': '回答失败。',
  'chat.announcement.response.limited': '回答因达到 token 上限而结束。',
  'chat.announcement.response.stopped': '回答已停止。',
  'chat.announcement.response.blocked': '回答已被阻止。',
  'chat.announcement.response.ended': '回答已结束。',
  'chat.announcement.tool.generic': '工具调用',
  'chat.announcement.tool.started': '工具 {tool} 已开始。',
  'chat.announcement.tool.completed': '工具 {tool} 已完成。',
  'chat.announcement.tool.failed': '工具 {tool} 失败。',
  'chat.announcement.tool.stopped': '工具 {tool} 已停止。',
  'chat.announcement.interaction.approval': '需要你审批工具操作。',
  'chat.announcement.interaction.question': '需要你回答问题。',
  'chat.announcement.interaction.planReview': '需要你审阅计划。',
  'chat.announcement.interaction.generic': '需要你处理一项请求。',
  ...
  'message.user': '用户消息',
  'message.assistant': 'Assistant 回复',
...
export const en = {
  ...
  'chat.log': 'Conversation transcript',
  'chat.deepDiving': 'Deep diving...',
  'chat.announcement.response.started': 'Response started.',
  'chat.announcement.response.completed': 'Response completed.',
  'chat.announcement.response.failed': 'Response failed.',
  'chat.announcement.response.limited': 'Response ended at the token limit.',
  'chat.announcement.response.stopped': 'Response stopped.',
  'chat.announcement.response.blocked': 'Response was blocked.',
  'chat.announcement.response.ended': 'Response ended.',
  'chat.announcement.tool.generic': 'tool call',
  'chat.announcement.tool.started': 'Tool {tool} started.',
  'chat.announcement.tool.completed': 'Tool {tool} completed.',
  'chat.announcement.tool.failed': 'Tool {tool} failed.',
  'chat.announcement.tool.stopped': 'Tool {tool} stopped.',
  'chat.announcement.interaction.approval': 'A tool action needs your approval.',
  'chat.announcement.interaction.question': 'A question needs your answer.',
  'chat.announcement.interaction.planReview': 'A plan needs your review.',
  'chat.announcement.interaction.generic': 'A request needs your attention.',
