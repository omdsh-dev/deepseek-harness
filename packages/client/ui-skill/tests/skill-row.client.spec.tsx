...
describe('SkillRow', () => {
  it('renders a compact Bash-shaped summary and discloses the exact instructions', () => {
    ...
    const row = screen.getByRole('button', { name: 'skill 加载完成Skilldsh-manage-issues' })
    expect(row.getAttribute('aria-expanded')).toBe('false')
    const bodyId = row.getAttribute('aria-controls')
    ...
    expect(document.getElementById(bodyId as string)?.hidden).toBe(false)
