...
function isComposing(event: KeyboardEvent<HTMLTextAreaElement>): boolean {
  // Some legacy engines expose only the historical 229 composition signal.
  // Keep that compatibility read isolated from the deprecated DOM declaration.
  const legacyEvent = event.nativeEvent as unknown as { readonly keyCode?: number }
  return event.nativeEvent.isComposing || legacyEvent.keyCode === 229
}
