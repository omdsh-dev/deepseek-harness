...
Testing tiers and validity rules. Commands: [AGENTS.md](../AGENTS.md). Linked Agent Notes explain decisions.
...
- **Core accessibility**: [Three-engine commands and non-AT evidence](../.agents/notes/implemented/testing/2026-08-31-versioned-core-browser-accessibility-evidence.md).
