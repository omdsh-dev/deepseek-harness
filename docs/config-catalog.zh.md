...
来源： [`packages/bundle/headless/src/index.ts:49`](../packages/bundle/headless/src/index.ts)
...
来源： [`packages/shell/tool-pwsh-persistent/src/index.ts:479`](../packages/shell/tool-pwsh-persistent/src/index.ts)
