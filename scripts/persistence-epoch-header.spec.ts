...
// The full source compiler inventory uses the coverage lane's 90-second budget.
it('requires a version bump before request headers can carry retired system text', { timeout: 90_000 }, () => {
