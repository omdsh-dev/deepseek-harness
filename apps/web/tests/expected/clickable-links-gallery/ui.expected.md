- main:
  ...
  - tabpanel "Chat":
    - log "Conversation transcript":
      ...
      - text: Write
      - button "Open file site/report.html": site/report.html
      - text: +1 -0 Completed
      - button "Write Completed a/style.css +1 -0"
      - text: Write
      - button "Open file a/style.css": a/style.css
      - text: +1 -0 Completed
      - button "Write Completed b/style.css +1 -0"
      - text: Write
      - button "Open file b/style.css": b/style.css
      - text: +1 -0 Completed
      - button "Write Completed site/index.html +1 -0"
      - text: Write
      - button "Open file site/index.html": site/index.html
      - text: +1 -0 Completed
      - button "Write Completed site/app.js +1 -0"
      - text: Write
      - button "Open file site/app.js": site/app.js
      - text: +1 -0 Completed
      - button "Edit Completed src/tokens.css +1 -1" [expanded]
      - text: Edit
      - button "Open file src/tokens.css": src/tokens.css
      - text: +1 -1
      - button "Copy"
      ...
      - text: Completed
      - button "Read Completed docs/guide.md" [expanded]
      - text: Read
      - button "Open file docs/guide.md": docs/guide.md
      - text: docs/guide.md
      - button "Copy"
      ...
      - text: Completed
      - button "Glob **/*.css"
      - button "Completed Bash List the built site"
