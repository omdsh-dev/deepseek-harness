...
The migration starts at official tag `dsh-v0.1.5-rc.2`, revision `fb2c4b9e698e30edb738bca4cf0618587db7d203`. Current upstream owns Session and layout state. Component owners retain native semantics, keyboard composites, focus containment and restoration, quiet live announcements, and bounded headless text or JSON output.
