...
Assistive-technology use and versioned accessibility verification require a stable final result, not a second CLI application or a Session-event stream.
